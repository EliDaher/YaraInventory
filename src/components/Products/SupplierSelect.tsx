...
export default function SupplierSelect({isOpen, setIsOpen, supplierId, setSupplierId, className, withDataTable}: SupplierSelectProps) {
    ...
    const addSupplierMutation = useMutation({
        mutationFn: (newSupplier: any) => addSupplier({...newSupplier, balance: 0}),
        onSuccess: () => {
    ...
    return (
        <PopupForm
            ...
            trigger={
                ...
                >{!supplierId ?'اختيار المورد' : supplierName}</Button>
            }
        >
            ...
            <Button 
                ...
                className='w-full'
            >{addSupplierMutation.isPending ? 'جاري الإضافة...' : 'اضافة'}</Button>
